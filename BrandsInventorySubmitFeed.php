 ...
 *  PHP Version 5
 *
 *  @category    Brands Cycle And Fitness
 ...
 *  @description My derivation from the php submit feed sample
 */
/******************************************************************************* 
...
parseAndReplace("./inbound/example.txt");
...
/********* Begin Comment Block *********/
// open a temporary file to read the flat file feed that needs to be sent to Amazon
$feedHandle = fopen('./inbound/example.txt', 'r');
  ...
  function invokeSubmitFeed(MarketplaceWebService_Interface $service, $request) 
  {
      try {
              $response = $service->submitFeed($request);
                ...
                fwrite($feedIdFile, $reponse->getFeedSubmissionId());
                fclose($feedIdFile);
